  ...
  return <AnimatePresence>
    ...
    >
      ...
      <motion.div initial={{ opacity: 0, y: 12, scale: 0.965 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.72, ease: [0.16, 1, 0.3, 1] }} style={{ position: "relative", zIndex: 1, width: "min(72vw, 330px)", textAlign: "center" }}>
        <div style={{ filter: "brightness(1.5)" }}><Image src="/logos/proodz-logo.svg" alt="Proodz — logo" width={340} height={62} priority style={{ display: "block", width: "100%", height: "auto", objectFit: "contain" }} onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = "/logo-placeholder.svg"; }} /></div>
